...
## `[0.2.1]` - 22-07-2019
### Updated
- `calc.js` file to include new `Math.js` & `abs()` function from library.
- `test.js` file to include new `Math.js` & `abs()` function from library.
### Deleted
- `index.html` because file served no purpose.
